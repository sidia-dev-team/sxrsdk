...
public class SampleHelper {
    ...
    public SXRNode createQuadPlane(SXRContext gvrContext) {
        ...
        SXRNode polygonObject = new SXRNode(gvrContext, mesh, mat);
    ...
    public void initCursorController(SXRContext gvrContext, final ARMain.TouchHandler handler) {
        ...
        mCursor = new SXRNode(gvrContext,
